  ...
  return (
    <div className="space-y-12 pb-40 animate-in fade-in slide-in-from-bottom-6 duration-700 bg-black min-h-screen">
      ...
      <div className="grid grid-cols-2 gap-6 px-2">
         <div className="bg-amber-500/5 border border-amber-500/10 p-6 rounded-3xl shadow-sm relative overflow-hidden group hover:bg-amber-500/10 transition-all">
            <Sunrise className="w-5 h-5 text-amber-500 mb-4 group-hover:scale-110 transition-transform" />
            <p className="text-[10px] font-bold text-amber-500/60 uppercase tracking-widest mb-1">Sunrise</p>
            <p className="text-2xl font-serif font-bold text-white tracking-tight">{new Date(current.sys.sunrise * 1000).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
            <Sun className="absolute -bottom-4 -right-4 w-20 h-20 text-amber-500/5 group-hover:rotate-12 transition-transform" />
         </div>
         <div className="bg-orange-500/5 border border-orange-500/10 p-6 rounded-3xl shadow-sm relative overflow-hidden group hover:bg-orange-500/10 transition-all">
            <Sunset className="w-5 h-5 text-orange-500 mb-4 group-hover:scale-110 transition-transform" />
            <p className="text-[10px] font-bold text-orange-500/60 uppercase tracking-widest mb-1">Sunset</p>
            <p className="text-2xl font-serif font-bold text-white tracking-tight">{new Date(current.sys.sunset * 1000).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
            <Moon className="absolute -bottom-4 -right-4 w-20 h-20 text-orange-500/5 group-hover:rotate-12 transition-transform" />
         </div>
      </div>
